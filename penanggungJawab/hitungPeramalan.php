        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <span class="text-muted fw-light">Dashboard / Pengadaan /</span> Hitung Peramalan
              </h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">  
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Hitung Peramalan</h5>
                    </div>
                    <div class="card-body">
                      <form>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-company">Sisa Stok</label>
                          <input type="text" class="form-control" value="8" id="basic-default-company" placeholder="ACME Inc." readonly/>
                        </div>
                        <div class="col mb-3">
                                    <label for="supplier" class="form-label">Untuk Periode</label>
                        ...
                        <a href="pilihSupplier.php" class="btn btn-primary">Hitung Peramalan</a>
                      </form>
                    </div>
                  </div>
                </div>
